...
const fieldCustomInfoDatePicker =  {
    fieldType: 'group',
    name: 'field_custom_info_date_picker',
    ...
    fields: [
        {
            ...
            fieldHelpText: __('The current date at initialization.', 'native-custom-fields')
        },
        {
            fieldType: 'radio',
            name: 'dateOrder',
...
export default fieldCustomInfoDatePicker;
